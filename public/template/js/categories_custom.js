    ...
    function initFixProductBorder()
    {
    	if($('.product_filter').length)
    	{
    		...
    		else if(wdth < 576)
			{
				...
				for(var i = 1; i < products.length; i+=4)
				{
					var product = $(products[i]);
					product.css('border-right', 'none');
				}
	...
	*/
     ...
     function initPriceSlider()
    {
		$( "#slider-range" ).slider(
		{
			...
			{
				var tes = $( "#amount" ).val( "Rp" + ui.values[ 0 ] + " - Rp" + ui.values[ 1 ] );
				
			}
		});
			
		var test = $( "#amount" ).val( "Rp" + $( "#slider-range" ).slider( "values", 0 ) + " - Rp" + $( "#slider-range" ).slider( "values", 1 ) );
