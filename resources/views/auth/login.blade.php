            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                           <div class="col-md-6 col-form-label text-md-right" style="position: all; top: 50%; "> 
                             <div class="g-recaptcha" data-sitekey="6Lcedo8UAAAAAJiXNCyROi20_8GgOdtk730O3cNt"></div>
                           </div>
                        </div>
                    ...
                    <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <a href="/auth/google" class="btn btn-github"><i class="fa fa-google"></i> Github</a>
