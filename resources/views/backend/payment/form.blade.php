            ...
            <form id="form-customer" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-md-3 control-label">Tipe Pembayaran </label>
                        <div class="col-md-6">
                            <input type="text" id="PaymentType" name="PaymentType" class="form-control" autofocus required>
