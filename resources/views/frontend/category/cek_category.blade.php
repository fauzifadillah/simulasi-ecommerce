...
<!-- 									<div  id="ProductName"> </div> -->
								...
								<div class="page_next" onClick="loadMore()"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></div>
								<div class="next_page_1"></div>
...
function loadMore() {
    console.log(i);
    $.ajax({
        url: "/category-front/productlist/?page=",
        data: {
            page: i,
