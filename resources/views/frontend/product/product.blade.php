...
<link rel="stylesheet" type="text/css" href="{{ asset('template/styles/single_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{ asset('template/styles/single_responsive.css')}}">
		...
		<div class="row">
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="{{route('home')}}">Home</a></li>
						<li><a href="{{route('category-front')}}"><i class="fa fa-angle-right" aria-hidden="true"></i>Kategori Produk</a></li>
						<li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true" id="product_name"></i>Produk </a></li>
					</ul>
				</div>
		...
		<div class="row">
					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li><img src="{{ asset('template/images/single_1_thumb.jpg')}}" alt="" data-image="{{ asset('template/images/single_1.jpg')}}"></li>
									<li class="active"><img src="{{ asset('template/images/single_2_thumb.jpg')}}" alt="" data-image="{{ asset('template/images/single_2.jpg')}}"></li>
									<li><img src="{{$product->photo}}" alt="" data-image="{{ asset('template/images/single_3.jpg')}}"></li>
								</ul>
							</div>
						</div>
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url({{$product->photo}})"></div>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					<div id="ProductName" class="product_details_title">
						<h2> {{$product->ProductName}} </h2>
						<p>{{$product->ProductDescription}}</p>
					</div>
					<div class="free_delivery d-flex flex-row align-items-center justify-content-center">
						<span class="ti-truck"></span><span>Biaya kirim GRATIS!</span>
					</div>
					...
					<div class="quantity d-flex flex-column flex-sm-row align-items-sm-center">
						...
						<div class="red_button add_to_cart_button"><a id="{{ $product->id }}" class="addCart" href="javascript:void(0)">add to cart</a></div>
				...
				<div class="col">
					<div class="tabs_container">
						<ul class="tabs d-flex flex-sm-row flex-column align-items-left align-items-md-center justify-content-center">
							<li class="tab active" data-active-tab="tab_1"><span>Deskripsi Produk</span></li>
							<li class="tab" data-active-tab="tab_2"><span>Informasi Produk</span></li>
					...
					<div id="tab_1" class="tab_container active">
						<div class="row">
							<div class="col-lg-5 desc_col">
								...
								<div class="tab_image">
									<img src="{{asset('template/images/desc_1.jpg')}}" alt="">
								</div>
								<div class="tab_text_block">
							...
							<div class="col-lg-5 offset-lg-2 desc_col">
								<div class="tab_image">
									<img src="{{asset('template/images/desc_2.jpg')}}" alt="">
								</div>
								<div class="tab_text_block">
									<h2>Pocket cotton sweatshirt</h2>
									<p>Nam tempus turpis at metus scelerisque placerat nulla deumantos solicitud felis. Pellentesque diam dolor, elementum etos lobortis des mollis ut...</p>
								...
								<div class="tab_image desc_last">
									<img src="{{asset('template/images/desc_3.jpg')}}" alt="">
								</div>
							</div>
						</div>
					</div>
					...
					<div id="tab_2" class="tab_container">
						<div class="row">
							<div class="col additional_info_col">
								...
								<p>Warna<span> {{$product->Color}} </span></p>
								<p>Ukuran:<span>{{$product->Size}}</span></p>
							</div>
						</div>
					</div>
...
<script src="{{asset('template/js/single_custom.js')}}"></script>
