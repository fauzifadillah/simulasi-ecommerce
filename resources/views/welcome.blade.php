...
<!--             </ul>
    ...
    <div class="main_slider" style="background-image:url(template/images/slider_1.jpg)">
            ...
            <div class="row align-items-center fill_height">
                <div class="col">
                    <div class="main_slider_content">
                        <h6>Koleksi 2019</h6>
                        <h1>Produk Baru</h1>
                <div class="red_button shop_now_button"><a href="{{route('category-front')}}">shop now</a></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <!--   <div class="banner">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="banner_item align-items-center" style="background-image:url(template/images/banner_1.jpg)">
                        <div class="banner_category">
                            <a href="{{ route('category-front') }}">Kategori 1</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner_item align-items-center" style="background-image:url(template/images/banner_2.jpg)">
                        <div class="banner_category">
                            <a href="categories.html">Kategori 2</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="banner_item align-items-center" style="background-image:url(images/banner_3.jpg)">
                        <div class="banner_category">
                            <a href="categories.html">Kategori 3</a>
                        </div>
                    </div>
                </div>
            </div>
